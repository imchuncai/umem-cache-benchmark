...
are very close. But REDIS only used 82% of the configured memory. And POGOCACHE
really not respect the memory limit, it used more than 40% of the limitation.
...
::
	...
	-args false 2147483648 525312 20 80 80 16 0 [fe80::4038:6954:f1a3:4d0f%end0]
	goos: linux
	goarch: arm64
...
::
	...
	=======================================================
	case:   16352    hot:    3270(20%)    hot_access: 80%
	get:   65408    hit:   46596    hit_rate: 71.24%
	hot:   52259    hit:   45352    hit_rate: 86.78%
	VmHWM:	 2097136 kB    per_memory_hit_rate: 71.24%
	216.065s
	=======================================================
	65408	   3303341 ns/op	      216 hit/s/mem
	PASS
	ok  	github.com/imchuncai/umem-cache-benchmark	439.244s
...
::
	...
	=======================================================
	case:   16352    hot:    3270(20%)    hot_access: 80% 
	get:   65408    hit:   43076    hit_rate: 65.86% 
	hot:   52259    hit:   42492    hit_rate: 81.31% 
	VmHWM: 1710360 kB    per_memory_hit_rate: 65.86%
	198.119s
	=======================================================
	65408	   3028965 ns/op	      217 hit/s/mem
	PASS
	ok  	github.com/imchuncai/umem-cache-benchmark	395.208s

	out IO speed: 871Mb/s
...
::
	...
	-args false 2147483648 525312 20 80 80 16 0 192.168.101.10
	goos: linux
	goarch: arm64
	pkg: github.com/imchuncai/umem-cache-benchmark
