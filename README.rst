...
.. [#] Without TLS enabled, hit throughput is 6% to 24% higher than Memcached and 7% to 38% higher than Redis.
.. [#] With TLS enabled, hit throughput is 5% to 58% higher than Memcached and 7% to 113% higher than Redis.
